...
| `peaceiris/mdbook:v0.x.x-rust` | `rust:1.62-alpine3.16` | 880MB | `mdbook test` subcommand is available |
| `ghcr.io/peaceiris/mdbook:v0.x.x` | `alpine:3.16` | 24MB | GitHub Packages: Minimum image |
| `ghcr.io/peaceiris/mdbook:v0.x.x-rust` | `rust:1.62-alpine3.16` | 880MB | GitHub Packages: `mdbook test` subcommand is available |
