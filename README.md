...
|---|---|---|---|
| `peaceiris/mdbook:v0.x.x` | `alpine:3.17` | 24MB | Minimum image |
| `peaceiris/mdbook:v0.x.x-rust` | `rust:1.62-alpine3.17` | 880MB | `mdbook test` subcommand is available |
| `ghcr.io/peaceiris/mdbook:v0.x.x` | `alpine:3.17` | 24MB | GitHub Packages: Minimum image |
| `ghcr.io/peaceiris/mdbook:v0.x.x-rust` | `rust:1.62-alpine3.17` | 880MB | GitHub Packages: `mdbook test` subcommand is available |
